    ...
    <div className="home">
      ...
      >
        <Typography variant="body1" sx={{ maxWidth: "700px", mb:5 }}>
          ...
          le biais de notre association. Nous utilisons site pour informer, engager et collecter des fonds, tout en mettant en
          avant des articles pertinents et en vendant des produits dont les
          recettes sont reversées à des projets soutenant la cause
          palestinienne. La transparence et la mobilisation communautaire sont
