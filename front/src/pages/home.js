...
const Home = () => {
  ...
  return (
    <div className="home">
      ...
      <Container component="div" id="network">
        ...
        <Box component="div">
          <blockquote
            ...
            cite="https://www.tiktok.com/@_unjourdepaix"
            data-unique-id="_unjourdepaix"
          ...
          >
            <section>
              <a
                target="_blank"
                href="https://www.tiktok.com/@_unjourdepaix?refer=creator_embed"
              >
                @_unjourdepaix
              </a>
            </section>
        ...
        <Box component="div">
          <blockquote
            ...
            data-instgrm-permalink="https://www.instagram.com/p/C68MGQbNtdj/?utm_source=ig_embed&amp;utm_campaign=loading"
          ...
          >
            <div style="padding:16px;">
              {" "}
              <a
                href="https://www.instagram.com/p/C68MGQbNtdj/?utm_source=ig_embed&amp;utm_campaign=loading"
              ...
              <p style=" color:#c9c8cd; font-family:Arial,sans-serif; font-size:14px; line-height:17px; margin-bottom:0; margin-top:8px; overflow:hidden; padding:8px 0 7px; text-align:center; text-overflow:ellipsis; white-space:nowrap;">
                <a
                  ...
                  target="_blank"
                >
                  Une publication partagée par Un jour de paix 🍉
                  (@_unjourdepaix)
                </a>
              </p>
            </div>
